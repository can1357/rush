...
func init() {
	...
	genai.RegisterProviderType(TypeReasoningMetadata, func(data []byte) (genai.ProviderOptionsData, error) {
...
func (m ReasoningMetadata) MarshalJSON() ([]byte, error) {
	...
	return genai.MarshalProviderType(TypeReasoningMetadata, plain(m))
}
