...
func init() {
	genai.RegisterProviderType(TypeResponsesProviderOptions, func(data []byte) (genai.ProviderOptionsData, error) {
	...
	genai.RegisterProviderType(TypeResponsesReasoningMetadata, func(data []byte) (genai.ProviderOptionsData, error) {
...
func (m ResponsesReasoningMetadata) MarshalJSON() ([]byte, error) {
	...
	return genai.MarshalProviderType(TypeResponsesReasoningMetadata, plain(m))
}
...
func (o ResponsesProviderOptions) MarshalJSON() ([]byte, error) {
	...
	return genai.MarshalProviderType(TypeResponsesProviderOptions, plain(o))
}
...
func NewResponsesProviderOptions(opts *ResponsesProviderOptions) genai.ProviderOptions {
