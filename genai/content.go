...
//	func init() {
//	    genai.RegisterProviderType(TypeMyProviderOptions, func(data []byte) (genai.ProviderOptionsData, error) {
...
//	    return genai.MarshalProviderType(TypeMyProviderOptions, plain(m))
//	}
//
