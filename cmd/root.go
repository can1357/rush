  ...
  `,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if _, err := program.Run(); err != nil {
			...
			return errors.New("Rush crashed. If you'd like to report it, please copy the stacktrace above and open an issue at https://github.com/can1357/rush/issues/new?template=bug.yml") //nolint:staticcheck
		}
		return nil
	},
}
