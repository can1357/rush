...
curl https://charm.land | rush run "Summarize this website"

# Read from a file
rush run "What is this code doing?" <<< prrr.go

# Run in quiet mode (hide the spinner)
rush run --quiet "Generate a README for this project"
  `,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		// For example:
		//     rush run "Do something fancy" > output.txt
		//     echo "Do something fancy" | rush run > output.txt
		//
